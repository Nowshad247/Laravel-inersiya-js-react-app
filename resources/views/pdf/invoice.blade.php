...
.co-name { font-size:20px; font-weight:bold; color:#0f172a; }
.inv-label { font-size:26px; font-weight:bold; color:#0f172a; text-align:right; }
.inv-meta { font-size:11px; color:#64748b; text-align:right; line-height:1.8; }
...
.info-box { background:#f8fafc; border:1px solid #e2e8f0; padding:12px; }
.info-lbl { font-size:10px; font-weight:bold; text-transform:uppercase; letter-spacing:1px; color:#94a3b8; margin-bottom:6px; }
.info-name { font-size:14px; font-weight:bold; color:#0f172a; margin-bottom:3px; }
.info-val { font-size:11px; color:#475569; line-height:1.7; }
.tbl { width:100%; border-collapse:collapse; margin-bottom:16px; }
.tbl th { background:#0f172a; color:#fff; padding:9px 12px; font-size:10px; text-transform:uppercase; letter-spacing:1px; text-align:left; }
.tbl th.r { text-align:right; }
.tbl td { padding:9px 12px; border-bottom:1px solid #f1f5f9; vertical-align:top; font-size:12px; }
.tbl tr:nth-child(even) td { background:#f8fafc; }
.tbl td.r { text-align:right; }
.ft { font-weight:600; color:#0f172a; }
.fd { font-size:10px; color:#94a3b8; margin-top:2px; }
.sum-tbl { width:100%; border-collapse:collapse; }
.sum-tbl td { padding:5px 12px; font-size:12px; }
.sum-row td:first-child { color:#64748b; }
.sum-row td:last-child { text-align:right; font-weight:500; }
.sum-tot { border-top:2px solid #0f172a; }
.sum-tot td { padding:10px 12px; font-size:14px; font-weight:bold; }
.sum-tot td:last-child { text-align:right; }
.sum-due td { background:#fef2f2; color:#dc2626; font-weight:bold; padding:10px 12px; font-size:13px; }
.sum-due td:last-child { text-align:right; }
.pay-box { background:#f0fdf4; border:1px solid #86efac; padding:12px; margin-bottom:16px; }
.note-box { background:#fafafa; border:1px solid #e2e8f0; padding:12px; }
  ...
  <table class="hdr">
    <tr>
      <td width="55%" style="vertical-align:top;">
        @if(!empty($logoBase64))
        <img src="{{ $logoBase64 }}" style="max-height:54px;max-width:160px;margin-bottom:6px;display:block;" alt="Logo">
        @endif
        ...
        <div class="info-box">
          ...
          <table style="width:100%;font-size:11px;">
            <tr>
              ...
              <td style="text-align:right;font-weight:600;text-transform:capitalize;">{{ $invoice->meta['payment_status'] ?? 'unpaid' }}</td>
            </tr>
            <tr>
              <td style="color:#64748b;padding:2px 0;">Method:</td>
              <td style="text-align:right;text-transform:capitalize;">{{ $invoice->meta['payment_method'] ?? '—' }}</td>
            </tr>
